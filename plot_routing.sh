...
echo "------------------------------------------------------------------------------"
echo ""
echo "1) ENC I      - Tráficos de único salto y de 2 saltos. Tráfico total ofrecido vs cursado"
echo "2) ENC II     - Tráficos de único salto y de 2 saltos. Tráfico total ofrecido vs cursado"
echo "3) ENC III    - Tráficos de único salto y de 2 saltos. Tráfico total ofrecido vs cursado"
echo "4) ENC III con reserva de 2 circuitos - Tráficos de único salto y de 2 saltos. Tráfico total ofrecido vs cursado"
echo ""
echo "------------------------------------------------------------------------------"
echo "-                            GRÁFICAS ALTERNATIVAS                           -"
echo "------------------------------------------------------------------------------"
echo ""
echo "5) ENC I      - Tráfico teórico vs tráfico simulado para tráficos de único salto y de 2 saltos"
